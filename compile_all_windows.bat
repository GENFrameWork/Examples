...
call ./../GEN/Batch/compile_windows.bat Console/ScriptsExample/Platforms/Windows /x32 scriptsexample 
...
call ./../GEN/Batch/compile_windows.bat Console/ScriptsExample/Platforms/Windows /x64 scriptsexample 
